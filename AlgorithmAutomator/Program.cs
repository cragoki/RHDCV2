        ...
        public static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddHostedService<AlgorithmAutomatorWorker>();

                    services.AddDbContextPool<RHDCV2Context>(options =>
                        options.UseLazyLoadingProxies().UseSqlServer(connectionString, sqlServerOptions => sqlServerOptions.CommandTimeout(120))
                    );

...
namespace DAL.Migrations
{
    ...
    [Migration("20240930095442_AddingEntitiesToStoreScrapedData")]
    partial class AddingEntitiesToStoreScrapedData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Horse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.Jockey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.RaceHorse", b =>
                {
                    ...
                    b.Property<string>("DistanceBetween")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Entities.RaceHorse", b =>
                {
                    b.HasOne("DAL.Entities.Horse", "HorseEntity")
                        .WithMany()
                        .HasForeignKey("HorseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Entities.Jockey", "JockeyEntity")
                        .WithMany()
                    ...
                    b.HasOne("DAL.Entities.Trainer", "TrainerEntity")
                        .WithMany()
